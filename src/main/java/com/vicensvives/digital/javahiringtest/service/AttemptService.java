...
public class AttemptService {
    ...
    public Attempt save(Attempt attempt) throws UnsupportedOperationException{
        if (attempt.getGrade() > 100 || attempt.getGrade() < 0){
            throw new UnsupportedOperationException("Grade have to has value between 0 and 100");
        }
