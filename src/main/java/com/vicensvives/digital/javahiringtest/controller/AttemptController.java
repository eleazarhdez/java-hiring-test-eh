...
public class AttemptController {
    ...
    public CreateAttemptResponse createAttempt(@RequestBody CreateAttemptRequest request) throws InvalidDataValueException {
    ...
    public ResponseEntity<String> processValidationError(InvalidDataValueException e) {
