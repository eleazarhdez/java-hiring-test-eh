...
public class StubBookStructureService implements BookStructureService {
    ...
    public static final UnitId UNIT_ID = new UnitId("9f50d492-03fe-4e42-8717-c3ce87650dd2");
    ...
    private final Map<ActivityId, SectionId> activityToSection = ImmutableMap.<ActivityId, SectionId>builder()
        ...
        .put(new ActivityId("3cafb913-cf92-4aa9-8a83-6be5c3f05c43"), SECTION_ID_A)
        .put(new ActivityId("9a1b3747-af98-481c-ac24-33544200f8b0"), SECTION_ID_B)
        .put(new ActivityId("9838997b-5e07-43e1-9cce-0a75dd27fcd5"), SECTION_ID_B)
        .build();

    private final Map<SectionId, UnitId> sectionToUnit = ImmutableMap.<SectionId, UnitId>builder()
        .put(SECTION_ID_A, UNIT_ID)
        .put(SECTION_ID_B, UNIT_ID)
        .build();


    @Override
    public Optional<SectionId> getSectionOfActivity(ActivityId activityId) {
        return ofNullable(activityToSection.get(activityId));
    }

    @Override
    public Optional<UnitId> getUnitOfSection(SectionId sectionId) {
        return ofNullable(sectionToUnit.get(sectionId));
    }
